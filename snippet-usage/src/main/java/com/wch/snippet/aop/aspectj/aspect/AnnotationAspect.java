...
import com.wch.snippet.aop.aspectj.AuthUtil;
...
public class AnnotationAspect {
     ...
     * 匹配有指定注解的方法
     */
    @Pointcut("@annotation(com.wch.snippet.aop.aspectj.AdminOnly)")
     ...
     */
    @Pointcut("@within(com.wch.snippet.annotation.custom.Beta)")
    public void within() {
    }
